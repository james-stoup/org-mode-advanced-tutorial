#+TITLE: Org Mode Advanced Tutorial
...
This guide IS NOT for new Emacs users or for new Org Mode users. If you are new to Emacs, go check out [[https://www.youtube.com/c/SystemCrafters][System Crafters]] on Youtube. That guys is amazing. If you are new to Org Mode then I have a [[https://github.com/james-stoup/emacs-org-mode-tutorial][guide for new users]] that I encourage you to check out. If you are still here I'm going to assume that you already have Emacs fairly well configured to your tastes and don't need the basics explained to you.
...
![[file:images/root-capture-templates.png][Opening the capture templates]]

*Opening the sub capture templates*
![[file:images/sub-capture-templates.png][Opening a sub capture template]]
...
*Adding a tag*
![[file:images/fantasy-tag.png][Adding a tag]]

*Adding the title*
![[file:images/book-title.png][Adding the title]]

*Adding the author*
![[file:images/book-author.png][Adding the author]]

*Adding the source*
![[file:images/book-source.png][Adding the source]]

*Editing the complete book entry*
![[file:images/new-book-capture.png][Adding the complete book]]
...
Let's go over what each of these extra options actually do. Before we start though it is helpful to first look over the [[https://orgmode.org/manual/Export-Settings.html][Org Mode Export Settings]] that are defined in the official documentation. Pay close attention to all the various entries for the ~OPTIONS~ keyword. In this case I'm only using the ~num~ and ~H~ options, however as you can see there are quite a few choices.
...
![[file:images/before-pretty-css.png][Before #1]]

*Text, Before*
![[file:images/before-example-2.png][Before #2]]

And here is the new, prettier version.

*Table of Contents, After*
![[file:images/after-pretty-css.png][After #1]]

*Text, After*
![[file:images/after-example-2.png][After #2]]
...
For reference, here is the PDF that I produced of [[file:README.pdf][this guide]].
...
Here you go, the [[file:latex-pdf.setup][LaTeX PDF setup file]].
...
The real trick is installing [[https://revealjs.com/][Reveal.js]] to power everything. Reveal is a very cool javascript utility for creating beautiful HTML presentations. However, you will also need to install an Emacs package to interface with Reveal, and that's where this gets a little weird. If you just search for "Emacs" and "reveal" you might find:
...
So which should you use? In my configuration, I use [[https://github.com/emacsmirror/org-re-reveal][org-re-reveal]]. It has worked well for me and I really like it. However, I think the consensus is drifting towards ~emacs-reveal~. Checkout this [[https://oer.gitlab.io/emacs-reveal-howto/howto.html#/sec-title-slide][great walkthrough]] for ~emacs-reveal~ to see if it is what you want. Either should be fine.
...
![[file:images/org-roam-capture-template-1.png][Capture template #1]]

*Capture Template part 2*
![[file:images/org-roam-capture-template-2.png][Capture template #2]]

*Capture Template part 3*
![[file:images/org-roam-capture-template-3.png][Capture template #3]]
...
*Backlinks*
![[file:images/org-roam-backlinks.png][Backlinks]]
...
Hopefully you've already read the [[*Advanced Capture Templates][Advanced Capture Templates]] section of this guide and were suitably impressed. We are going to apply those same concepts to Org Roam. However, it isn't an exact 1:1 translation, so there are some minor things we will need to tweak. If you attempt to use the standard Org Mode syntax here, it will break your capture templates.
...
![[file:images/org-roam-ui-1.png][Org Roam UI #1]]

*Org Roam UI zoomed in*
![[file:images/org-roam-ui-2.png][Org Roam UI #2]]

*Org Roam UI Node selected*
![[file:images/org-roam-ui-3.png][Org Roam UI #3]]

*Org Roam UI Node details *
![[file:images/org-roam-ui-4.png][Org Roam UI #4]]
